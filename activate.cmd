...
cscript //nologo slmgr.vbs /ato | find /i "successfully" && (echo.&echo ============================================================================&echo.&echo #Subscribe to this Youtube Channel: nhorliemac&echo.&echo  #Script creator official blog: MSGuides.com&echo.&echo #How it works: bit.ly/kms-server&echo.&echo #Please consider supporting this project: subscribe nhorliemac or donate:GCASH 0967 359 6080&echo #Your support is helping me keep my servers running everyday!&echo.&echo ============================================================================&choice /n /c YN /m "Would you like to visit my blog [Y,N]?" & if errorlevel 2 exit) || (echo The connection to my KMS server failed! Trying to connect to another one... & echo Please wait... & echo. & echo. & set /a i+=1 & goto server)
